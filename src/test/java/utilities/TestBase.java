...
public class TestBase {
    ...
    public void webElementResimCek(WebElement target) throws IOException {

        LocalDateTime ldt=LocalDateTime.now();
        DateTimeFormatter dtf= DateTimeFormatter.ofPattern("YYMMddHHmmss");

        File tumSayfaSShot= new File("target/ScreenShot/webElementResimCek"+ldt.format(dtf)+".jpeg");
